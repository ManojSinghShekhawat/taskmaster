...
const ProjectInProgressTasks = ({ tasksWithProjects, projectId }) => {
  const task = tasksWithProjects.filter(
    (obj) => obj.task.status === "In Progress" && obj.task.project === projectId
  );
...
export default ProjectInProgressTasks;
